...
Pour nous faciliter la gestion des valeurs de configuration, nous allons étendre la class [HashMap]() du JDK
...
L'opération de lecture est grandement facilité par l'utilisation de l'objet [Properties]() du JDK, il faut ensuite
...
Dans ce troisième et dernier exemple, la valeur du fichier de propriété est convertie en une instance de [Dimension](),
et est
stockée dans la map:
