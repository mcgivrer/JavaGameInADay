...
La Programmation Orientée Objet : un modèle puissant
À la base, la programmation orientée objet repose sur quatre piliers principaux :
...
[source,bash]
----
java examples.MonProgramme.java Parametre1=1 Parametre2=2
----
...
[source,java]
----
public class examples.MonProgramme {
...
[source,Java]
----
public class examples.MonProgramme2 {

    //<1>
    public examples.MonProgramme2() {
    ...
    public static void main(String[] args) {
        //<3>
        examples.MonProgramme2 prog = new examples.MonProgramme2();
        //<4>
        prog.run(args);
    }
}
