...
public interface Scene {
     ...
     */
    // <2>
    Collection<Entity2> getEntities();
    ...
    default Camera getActiveCamera() {
        Camera cam = (Camera) (getEntities().stream().filter(e -> (e instanceof Camera)).findFirst().get());
        return cam;
    }
}
