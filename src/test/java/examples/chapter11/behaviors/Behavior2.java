package examples.chapter11.behaviors;
 ...
 * application.
 */
public interface Behavior2<Entity2> {
    /**
     ...
     */
    default void update(Entity2 e, double delta) {
    }
     ...
     */
    default void draw(Graphics2D g, Entity2 e) {
    }
     ...
     */
    default void dispose(Entity2 e) {
    }

    void collide(Entity2 entityA, Entity2 entityB);
}
