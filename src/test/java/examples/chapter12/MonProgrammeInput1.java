 ...
 */
public class MonProgrammeInput1 extends TestGame implements Game {
    /**
     ...
     */
    private String configFilePath = "/input1.properties";
    ...
    public static void main(String[] args) {
        MonProgrammeInput1 prog = new MonProgrammeInput1();
        prog.run(args);
    }
