...
/**
 * MonProgrammeGameLoop1 is a class that extends TestGame and implements KeyListener and Game interfaces.
 * <p>
...
public class MonProgrammeGameLoop1 extends TestGame implements KeyListener, Game {
    ...
    /**
     * Represents the main application window for the MonProgrammeGameLoop1 class.
     * <p>
    ...
    /**
     * A collection of scenes managed by the MonProgrammeGameLoop1 class.
     * <p>
     ...
     */
    public void input(Scene currentScene) {
    ...
    public static void main(String[] args) {
        MonProgrammeGameLoop1 prog = new MonProgrammeGameLoop1();
        prog.run(args);
    }
