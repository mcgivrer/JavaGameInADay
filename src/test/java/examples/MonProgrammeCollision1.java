 ...
 */
public class MonProgrammeCollision1 extends TestGame implements KeyListener, Game {
    /**
    ...
    public static void main(String[] args) {
        MonProgrammeCollision1 prog = new MonProgrammeCollision1();
        prog.run(args);
    }
